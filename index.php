...
<head>
	<title>Website bán máy tính Hùng Dũng</title>
	<!-- Meta tag Keywords -->
...
<body>
	<?php
		...
		include "views/include/slider.php";
		...
		if($tam == 'danhmuc'){
			include "views/include/danhmuc.php";
		}else if($tam == 'chitietsp'){
			include "views/include/chitietsp.php";
		}else if($tam == 'giohang'){
			include "views/include/giohang.php";
		}else if($tam == 'timkiem'){
		 	include 'views/include/timkiem.php';
		}else if($tam == 'tintuc'){
		 	include 'views/include/tintuc.php';
		}else if($tam == 'chitiettin'){
		 	include 'views/include/chitiettin.php';
		}
		else {
